...
const getUsers = require("./src/routes/getUser");
...
app.use("/admin/users", require("./src/routes/getUser"));
app.use("/admin/comments", require("./src/routes/getUserComments"));
app.use("/admin/dashboard", require("./src/routes/dashboard"));
...
app.listen(port, () => console.info(`mã localhost của bạn là: ${port}`));
